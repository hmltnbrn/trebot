...
${process.env.BOT_PREFIX || '.'}trebot [a]nswer <answer text> ... Try to answer previous non-timed question (will reveal answer and increase the score for the contestant if answered correctly)
